// Adapted from https://github.com/s9varesc/url-fuzzing/blob/master/livingstandard-url-base.scala
// As of commit a18cbe7a073e0ffcd9440264caad1c9d87da337a
...
Grammar(
  ...
  'pathRelativeURL := ('URLpathSegment ~ "/").rep,
